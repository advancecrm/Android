...
public class VectorWSPerson extends Vector<WSPerson> implements KvmSerializable {
    
    
    public VectorWSPerson(){}
    
    public VectorWSPerson(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
