...
public class TabFullScreenLock extends Activity implements OnClickListener {
    WebView webView;
    String s = "";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.neuro_img:
                TabFullScreenLock.this.finish();
                startActivity(new Intent(TabFullScreenLock.this, TabCalculateMaturityLock.class));
                break;
