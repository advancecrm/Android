...
public class CalculateMaturityLock extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.physical_mature_btn:
                ...
                CalculateMaturityLock.this.finish();
                startActivity(new Intent(CalculateMaturityLock.this, FullScreenLock.class));
