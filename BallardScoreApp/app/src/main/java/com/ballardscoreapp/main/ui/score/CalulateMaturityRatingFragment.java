...
public class CalulateMaturityRatingFragment extends Activity implements
        OnClickListener {

    public static Activity act_obj;
    Globals globals;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        act_obj = CalulateMaturityRatingFragment.this;
    ...
    public void openAlert() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                CalulateMaturityRatingFragment.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.physical_mature_btn:
                CalulateMaturityRatingFragment.this.finish();
                startActivity(new Intent(CalulateMaturityRatingFragment.this, FullScreenActivity.class));
                break;
            ...
            case R.id.calc_maturity_rating_btn:
                ...
                if (globals.isPhyCalculated && globals.isNeuroCalculated) {
                    ...
                    CalulateMaturityRatingFragment.this.finish();
                    startActivity(new Intent(CalulateMaturityRatingFragment.this, MainActivity.class));
                } else {
                    openAlert();
                }
