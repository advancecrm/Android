...
public class FAQDetailFragment extends Fragment {
     ...
     */
    private FAQContent.FAQItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = FAQContent.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.faq_detail, container, false);

        // Show the dummy content as text in a TextView.
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.faq_detail)).setText(mItem.details);
        }
